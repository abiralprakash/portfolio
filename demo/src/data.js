// Single source of truth for the product lab. All content is verified against the
// existing portfolio (public/index.html, about.html, case/*.html, proof.html).
// No fabricated metrics, users, or revenue.
...
// Verified proof points (production framing, no vanity counts).
export const PROOF = [
...
export const SYSTEMS = [
  ...
  },
  {
    ...
    story: {
      ...
      outcome:
        'Moved from prototype to production intake running inside NepalIPMS.',
    },
  ...
  },
  {
    ...
    story: {
      ...
      intelligence:
        'A learning UX designed around how aspirants actually study on their phones.',
